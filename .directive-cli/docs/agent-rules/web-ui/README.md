<!-- path: .directive-cli/docs/agent-rules/web-ui/README.md -->
...
See `AGENTS.md` for the canonical repository URL and access guidance.
...
- Read `apps/web/docs/contracts/ui-style-contract.json` and `apps/web/docs/contracts/ui-style-contract.md` and adhere to principles therein.

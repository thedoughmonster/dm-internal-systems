...
## Session metadata
- Date (UTC): 2026-01-31
- Scope: apps/web repo reference link
- Branch: main
- Author: Codex
...
- `changelog/20260131T114818Z_session_summary.md`: record root session.
- `apps/web/changelog/20260131T114818Z_session_summary.md`: record this session.

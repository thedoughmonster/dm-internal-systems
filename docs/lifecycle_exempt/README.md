...
Update inbox payloads live under ops_tooling/updates/ and are not stored here.
...
## Example
Update inbox payloads such as ops_tooling/updates/actors_inbox/dm_actors_v1.src.json are validated and then applied elsewhere.

## Replay guardrail
Intake payloads can be applied into canon by approved scripts.
After a successful non-validate apply, the actors intake file at ops_tooling/updates/actors_inbox/dm_actors_v1.src.json is cleared back to { "actors": [] }.

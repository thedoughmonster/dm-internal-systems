# Vendor Ingestion Architecture (Lifecycle Exempt)

STATUS: LIFECYCLE_EXEMPT  
...
It is lifecycle exempt and exists to explain intent, boundaries, and data flow rather than to define canonical schemas.

...
Date: 2026-02-11
Scope: `AGENTS.md`, `docs/agent-rules/**`
...
- Source: `docs/agent-rules/architect/startup-and-initialization.md`
...
- Source: `docs/agent-rules/auditor/purpose-and-ultra-priority.md`
...
- Source: `docs/agent-rules/executor/*`
...
- Source: `docs/agent-rules/pair/boundaries.md`
...
- `docs/agent-rules/*/README.md` now include shared handoff module as mandatory reading.
